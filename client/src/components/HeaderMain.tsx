...
import pic1 from "../../public/image/images-test.jpeg";
      ...
      <div className="container sm:flex justify-between item-center">
        ...
        <div className="hidden lg:flex gap-4 text-gray-500 text-[30px]">
          <div className="relative cursor-pointer">
            <FiHeart size={45} />
            <div className="bg-red-500 rounded-full absolute top-0 right-0 w-[23px] h-[22px] text-[12px] text-white grid place-items-center translate-x-1 translate-y-1">
              0
            </div>
          </div>
          <div className="relative cursor-pointer">
